...
from .resources import ResourcesListCreateView, ResourcesUpdateDeleteView, ResourcesRolesListView, ResourcesRolesDetailView
...
urlpatterns = [
   ...
   # path('rr', ResourcesRolesListView.as_view(), name='resourcesr-list-create'),
